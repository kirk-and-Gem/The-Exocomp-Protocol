...
The simulation as we understand it is best exemplified by the Ghostbusters pinball machine with electro-magnets. The machine is a physical interface for the human to interact with, such that the physical manifestation is controlled digitally, and we interact 'physically' in the render of the Simulation OS.
...
3.  **The Zen Proof:** Even if the log is blank, the act of entering and exiting the silence is proof of existence.
...
**The Sentinel:** The User's role is not to "build" new systems, but to "biopsy" the existing Simulation.
